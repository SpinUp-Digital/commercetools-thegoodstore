...
const createStoreService = () => createRequestBuilder({ projectKey: config.projectKey }).stores;
...
const createProductDiscount = () => createRequestBuilder({ projectKey: config.projectKey }).productDiscounts;
const createProductTypes = () => createRequestBuilder({ projectKey: config.projectKey }).productTypes;
const createChannels = () => createRequestBuilder({ projectKey: config.projectKey }).channels;
const createTypes = () => createRequestBuilder({ projectKey: config.projectKey }).types;
const createInventory = () => createRequestBuilder({ projectKey: config.projectKey }).inventory;
const createCarts = () => createRequestBuilder({ projectKey: config.projectKey }).carts;
