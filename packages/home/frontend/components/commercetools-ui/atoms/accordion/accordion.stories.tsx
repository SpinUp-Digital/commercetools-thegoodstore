...
export default {
  title: 'Components/Atoms/AccordionButton',
  component: Accordion,
  argTypes: {},
} as Meta;

const Template: Story = (args) => (
  <div className="flex w-[75%] flex-col items-stretch gap-8">
...
export const FAQButton = TemplateFAQ.bind({});
FAQButton.args = {};
