        ...
        <Menu>
          <div className="relative flex space-x-8">
            <Menu.Button className="flex">
              ...
              <UserIcon className="text-primary-400 dark:text-light-100 h-6 w-6" aria-hidden="true" />
            </Menu.Button>
          ...
          >
            <Menu.Items className="dark:bg-primary-400 dark:shadow-3xl absolute right-0 top-6 z-50 mt-2 w-fit origin-top-right rounded-md bg-white shadow-sm ring-1 ring-black/5 focus:outline-none">
              <div className="py-1 ">
                <Menu.Item>
                  <ReferenceLink
                    target={accountLink}
                ...
                {account && (
                  <Menu.Item>
                    <button
                      ...
                      className="dark:bg-primary-400 dark:text-light-100 block w-36 cursor-pointer py-2 px-4 text-left text-sm hover:bg-gray-100"
                    >
