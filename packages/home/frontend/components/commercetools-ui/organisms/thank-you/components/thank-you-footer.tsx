...
const ThankYouFooter = () => {
  ...
  return (
    <div className="grid border-b border-neutral-400 pt-16 pb-24 md:border-b-0 lg:pb-0 lg:pt-36">
      <Typography
        className="mb-16 leading-[20px] text-primary-black md:mb-24 md:text-18 md:leading-normal"
        fontFamily="libre"
        fontSize={16}
      >
        {bottomSectionText?.title}
      </Typography>
      <Typography className="mb-24 text-secondary-black md:text-16" fontSize={14}>
        {bottomSectionText?.subtitle}
      </Typography>
      <Button className="w-full py-8 md:w-fit md:px-56 md:py-12">{bottomSectionText?.cta}</Button>
    </div>
  );
};
