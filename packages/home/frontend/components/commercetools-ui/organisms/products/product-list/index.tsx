...
const ProductList: React.FC<Props> = ({ serverUrl, categories, facetsConfiguration }) => {
  ...
  return (
    <div className="bg-neutral-200 py-52">
      <Configure {...(!searchQuery ? { filters: `categories.categoryId:${categoryId}` } : { query: searchQuery })} />
