    ...
    <>
      <div className="mt-16 pb-12 md:mt-0">
        <Typography
          ...
          fontSize={18}
          fontFamily="libre"
          className="mt-20 pl-16 text-primary-black md:mt-0 md:pl-24 md:text-22 lg:pl-44 lg:text-24"
        >
          {formatOrdersMessage({
            id: 'order.details',
      ...
      <div className="mt-8 flex flex-row pl-16 md:mt-12 md:px-0 md:pl-24 lg:mt-24 lg:pl-44">
        ...
        <Typography
          ...
          fontSize={14}
          fontFamily="inter"
          className="ml-8 whitespace-nowrap text-primary-black md:text-16"
        >
